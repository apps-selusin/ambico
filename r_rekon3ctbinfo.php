...
//
// Table class for r_rekon3
//
class crr_rekon3 extends crTableCrosstab {
	var $pegawai_id;
	var $tgl;
	var $jk_id;
	var $hk_def;
	...
	function __construct() {
		...
		$this->TableVar = 'r_rekon3';
		$this->TableName = 'r_rekon3';
		...
		// pegawai_id
		$this->pegawai_id = new crField('r_rekon3', 'r_rekon3', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// tgl
		$this->tgl = new crField('r_rekon3', 'r_rekon3', 'x_tgl', 'tgl', '`tgl`', 133, EWR_DATATYPE_DATE, 0);
		...
		// jk_id
		$this->jk_id = new crField('r_rekon3', 'r_rekon3', 'x_jk_id', 'jk_id', '`jk_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// hk_def
		$this->hk_def = new crField('r_rekon3', 'r_rekon3', 'x_hk_def', 'hk_def', '`hk_def`', 16, EWR_DATATYPE_NUMBER, -1);
		...
		// pegawai_pin
		$this->pegawai_pin = new crField('r_rekon3', 'r_rekon3', 'x_pegawai_pin', 'pegawai_pin', '`pegawai_pin`', 200, EWR_DATATYPE_STRING, -1);
		...
		// pegawai_nama
		$this->pegawai_nama = new crField('r_rekon3', 'r_rekon3', 'x_pegawai_nama', 'pegawai_nama', '`pegawai_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// pembagian2_nama
		$this->pembagian2_nama = new crField('r_rekon3', 'r_rekon3', 'x_pembagian2_nama', 'pembagian2_nama', '`pembagian2_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// jk_kd
		$this->jk_kd = new crField('r_rekon3', 'r_rekon3', 'x_jk_kd', 'jk_kd', '`jk_kd`', 200, EWR_DATATYPE_STRING, -1);
		...
		// jk_m
		$this->jk_m = new crField('r_rekon3', 'r_rekon3', 'x_jk_m', 'jk_m', '`jk_m`', 134, EWR_DATATYPE_TIME, -1);
		...
		// jk_k
		$this->jk_k = new crField('r_rekon3', 'r_rekon3', 'x_jk_k', 'jk_k', '`jk_k`', 134, EWR_DATATYPE_TIME, -1);
		...
		// scan_masuk
		$this->scan_masuk = new crField('r_rekon3', 'r_rekon3', 'x_scan_masuk', 'scan_masuk', '`scan_masuk`', 135, EWR_DATATYPE_DATE, 0);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_rekon3`";
	}
	...
	function getSqlDistinctSelect() {
		return ($this->_SqlDistinctSelect <> "") ? $this->_SqlDistinctSelect : "SELECT DISTINCT DATE_FORMAT(`tgl`,'%Y-%m-%d') FROM `v_rekon3`";
	}
