...
$lap_lembur__php = NULL; // Initialize page object first

class clap_lembur__php {
	...
	// Table name
	var $TableName = 'lap_lembur_.php';

	// Page object name
	var $PageObjName = 'lap_lembur__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'lap_lembur_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "lap_lembur__php", $url, "", "lap_lembur__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($lap_lembur__php)) $lap_lembur__php = new clap_lembur__php();

// Page init
$lap_lembur__php->Page_Init();

// Page main
$lap_lembur__php->Page_Main();
...
?>
<form id="myform" name="myform" class="form-horizontal" method="post" action="lap_lembur.php">
...
<?php
$lap_lembur__php->Page_Terminate();
?>
