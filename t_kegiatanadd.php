...
$t_kegiatan_add = NULL; // Initialize page object first

class ct_kegiatan_add extends ct_kegiatan {
	...
	// Page object name
	var $PageObjName = 't_kegiatan_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_kegiatanlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_kegiatanview.php")
...
// Create page object
if (!isset($t_kegiatan_add)) $t_kegiatan_add = new ct_kegiatan_add();

// Page init
$t_kegiatan_add->Page_Init();

// Page main
$t_kegiatan_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_kegiatan_add->Page_Render();
?>
...
var CurrentForm = ft_kegiatanadd = new ew_Form("ft_kegiatanadd", "add");

// Validate form
ft_kegiatanadd.Validate = function() {
...
ft_kegiatanadd.Form_CustomValidate = 
...
ft_kegiatanadd.ValidateRequired = true;
<?php } else { ?>
ft_kegiatanadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t_kegiatan_add->ShowPageHeader(); ?>
<?php
$t_kegiatan_add->ShowMessage();
?>
<form name="ft_kegiatanadd" id="ft_kegiatanadd" class="<?php echo $t_kegiatan_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_kegiatan_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_kegiatan_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_kegiatan_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
