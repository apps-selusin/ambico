...
//
// Table class for t_lembur2
//
class ct_lembur2 extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_lembur2';
		$this->TableName = 't_lembur2';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_lembur2`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// lembur_id
		$this->lembur_id = new cField('t_lembur2', 't_lembur2', 'x_lembur_id', 'lembur_id', '`lembur_id`', '`lembur_id`', 3, -1, FALSE, '`lembur_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pegawai_id
		$this->pegawai_id = new cField('t_lembur2', 't_lembur2', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', '`pegawai_id`', 3, -1, FALSE, '`pegawai_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl
		$this->tgl = new cField('t_lembur2', 't_lembur2', 'x_tgl', 'tgl', '`tgl`', ew_CastDateFieldForLike('`tgl`', 0, "DB"), 133, 0, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_lembur2`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_lembur2view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_lembur2view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_lembur2add.php?" . $this->UrlParm($parm);
		else
			$url = "t_lembur2add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_lembur2edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_lembur2add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_lembur2delete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->lama_lembur->EditValue = $this->lama_lembur->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->lama_lembur->Exportable) $Doc->ExportCaption($this->lama_lembur);
				} else {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->lama_lembur->Exportable) $Doc->ExportField($this->lama_lembur);
					} else {
