...
//
// Table class for t_pengecualian
//
class ct_pengecualian extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_pengecualian';
		$this->TableName = 't_pengecualian';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_pengecualian`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// pengecualian_id
		$this->pengecualian_id = new cField('t_pengecualian', 't_pengecualian', 'x_pengecualian_id', 'pengecualian_id', '`pengecualian_id`', '`pengecualian_id`', 3, -1, FALSE, '`pengecualian_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pegawai_id
		$this->pegawai_id = new cField('t_pengecualian', 't_pengecualian', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', '`pegawai_id`', 3, -1, FALSE, '`EV__pegawai_id`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// tgl
		$this->tgl = new cField('t_pengecualian', 't_pengecualian', 'x_tgl', 'tgl', '`tgl`', ew_CastDateFieldForLike('`tgl`', 0, "DB"), 133, -1, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tipe
		$this->tipe = new cField('t_pengecualian', 't_pengecualian', 'x_tipe', 'tipe', '`tipe`', '`tipe`', 16, -1, FALSE, '`tipe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_pengecualian`";
	}
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `pegawai_nama` FROM `pegawai` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`pegawai_id` = `t_pengecualian`.`pegawai_id` LIMIT 1) AS `EV__pegawai_id` FROM `t_pengecualian`" .
			") `EW_TMP_TABLE`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_pengecualianview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_pengecualianview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_pengecualianadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_pengecualianadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_pengecualianedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_pengecualianadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_pengecualiandelete.php", $this->UrlParm());
	}
