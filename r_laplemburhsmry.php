...
//		$item->Visible = TRUE;
	...
	function Page_DataRendered(&$footer) {
		...
		echo "<p><a href='kitir_lembur_hrn.php'><button>Cetak Slip Lembur</button></a></p>";
	}
...
<?php if ($Page->lapgroup_index->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="lapgroup_index"><div class="r_laplemburh_lapgroup_index"><span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="lapgroup_index">
<?php if ($Page->SortUrl($Page->lapgroup_index) == "") { ?>
		<div class="ewTableHeaderBtn r_laplemburh_lapgroup_index">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_laplemburh_lapgroup_index" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->lapgroup_index) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ewSummaryCaption r_laplemburh_lapgroup_index"><span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->SortUrl($Page->lapgroup_index) == "") { ?>
		<span class="ewSummaryCaption r_laplemburh_lapgroup_index">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r_laplemburh_lapgroup_index" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->lapgroup_index) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->lapgroup_index->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->lapgroup_index->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r_laplemburh_lapgroup_index"<?php echo $Page->lapgroup_index->ViewAttributes() ?>><?php echo $Page->lapgroup_index->GroupViewValue ?></span>
...
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_laplemburh_bagian"<?php echo $Page->bagian->ViewAttributes() ?>><?php echo $Page->bagian->GroupViewValue ?></span>
...
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_laplemburh_divisi"<?php echo $Page->divisi->ViewAttributes() ?>><?php echo $Page->divisi->GroupViewValue ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r_laplemburh_lapgroup_index"<?php echo $Page->lapgroup_index->ViewAttributes() ?>><?php echo $Page->lapgroup_index->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->bagian->Visible) { ?>
	<?php if ($Page->bagian->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_laplemburh_bagian"<?php echo $Page->bagian->ViewAttributes() ?>><?php echo $Page->bagian->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->divisi->Visible) { ?>
	<?php if ($Page->divisi->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_laplemburh_divisi"<?php echo $Page->divisi->ViewAttributes() ?>><?php echo $Page->divisi->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->no->Visible) { ?>
		<td data-field="no"<?php echo $Page->no->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_laplemburh_no"<?php echo $Page->no->ViewAttributes() ?>><?php echo $Page->no->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->nama->Visible) { ?>
		<td data-field="nama"<?php echo $Page->nama->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_laplemburh_nama"<?php echo $Page->nama->ViewAttributes() ?>><?php echo $Page->nama->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->nip->Visible) { ?>
		<td data-field="nip"<?php echo $Page->nip->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_laplemburh_nip"<?php echo $Page->nip->ViewAttributes() ?>><?php echo $Page->nip->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->jml_jam->Visible) { ?>
		<td data-field="jml_jam"<?php echo $Page->jml_jam->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_laplemburh_jml_jam"<?php echo $Page->jml_jam->ViewAttributes() ?>><?php echo $Page->jml_jam->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->tarif->Visible) { ?>
		<td data-field="tarif"<?php echo $Page->tarif->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_laplemburh_tarif"<?php echo $Page->tarif->ViewAttributes() ?>><?php echo $Page->tarif->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->total_lembur->Visible) { ?>
		<td data-field="total_lembur"<?php echo $Page->total_lembur->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_laplemburh_total_lembur"<?php echo $Page->total_lembur->ViewAttributes() ?>><?php echo $Page->total_lembur->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php
			...
			$Page->total_lembur->Count = $Page->Cnt[3][6];
			$Page->total_lembur->SumValue = $Page->Smry[3][6]; // Load SUM
			$Page->ResetAttrs();
			$Page->RowType = EWR_ROWTYPE_TOTAL;
			$Page->RowTotalType = EWR_ROWTOTAL_GROUP;
...
<?php if ($Page->total_lembur->Visible) { ?>
		<td data-field="total_lembur"<?php echo $Page->total_lembur->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_laplemburh_total_lembur"<?php echo $Page->total_lembur->ViewAttributes() ?>><?php echo $Page->total_lembur->SumViewValue ?></span></td>
<?php } ?>
	</tr>
<?php } ?>
<?php
...
<?php if ($Page->SubGrpColumnCount + $Page->DtlColumnCount > 0) { ?>
		<td colspan="<?php echo ($Page->SubGrpColumnCount + $Page->DtlColumnCount) ?>"<?php echo $Page->total_lembur->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->bagian->GroupViewValue, $Page->bagian->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[2][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
	</tr>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->lapgroup_index->Visible) { ?>
