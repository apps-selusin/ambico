...
class cpegawai extends cTable {
	...
	function __construct() {
		...
		$this->pegawai_telp->Sortable = FALSE; // Allow sort
		...
		$this->pegawai_status->Sortable = FALSE; // Allow sort
		...
		$this->tgl_lahir->Sortable = FALSE; // Allow sort
		...
		$this->tgl_mulai_kerja->Sortable = FALSE; // Allow sort
		...
		$this->tgl_resign->Sortable = FALSE; // Allow sort
		...
		$this->tgl_masuk_pertama->Sortable = FALSE; // Allow sort
		...
		$this->photo_path->Sortable = FALSE; // Allow sort
		...
		$this->nama_rek->Sortable = FALSE; // Allow sort
		...
		$this->no_rek->Sortable = FALSE; // Allow sort
	...
	function GetDetailUrl() {
		...
		if ($this->getCurrentDetailTable() == "t_lembur2") {
			$sDetailUrl = $GLOBALS["t_lembur2"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_pegawai_id=" . urlencode($this->pegawai_id->CurrentValue);
		}
		if ($sDetailUrl == "") {
