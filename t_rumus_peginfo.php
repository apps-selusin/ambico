...
class ct_rumus_peg extends cTable {
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `rumus_nama` FROM `t_rumus` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`rumus_id` = `t_rumus_peg`.`rumus_id` LIMIT 1) AS `EV__rumus_id` FROM `t_rumus_peg`" .
			") `EW_TMP_TABLE`";
