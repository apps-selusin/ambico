...
define("EWR_PROJECT_ID", "{6A79AFFA-AA3A-4CBB-8572-5F6C56B1E5B1}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "ambico", TRUE); // Project Name
...
define("EWR_RANDOM_KEY", 'pMbkhgEzsLWxefa6', TRUE); // Random key for encryption
...
define("EWR_TABLE_PREFIX", "{6A79AFFA-AA3A-4CBB-8572-5F6C56B1E5B1}", TRUE);
