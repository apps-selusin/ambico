...
$lap_lemburh__php = NULL; // Initialize page object first

class clap_lemburh__php {
	...
	// Table name
	var $TableName = 'lap_lemburh_.php';

	// Page object name
	var $PageObjName = 'lap_lemburh__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'lap_lemburh_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "lap_lemburh__php", $url, "", "lap_lemburh__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($lap_lemburh__php)) $lap_lemburh__php = new clap_lemburh__php();

// Page init
$lap_lemburh__php->Page_Init();

// Page main
$lap_lemburh__php->Page_Main();
...
?>
<form id="myform" name="myform" class="form-horizontal" method="post" action="lap_lemburh.php">
...
<?php
$lap_lemburh__php->Page_Terminate();
?>
