...
$lap_gaji3__php = NULL; // Initialize page object first

class clap_gaji3__php {
	...
	// Table name
	var $TableName = 'lap_gaji3_.php';

	// Page object name
	var $PageObjName = 'lap_gaji3__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'lap_gaji3_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "lap_gaji3__php", $url, "", "lap_gaji3__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($lap_gaji3__php)) $lap_gaji3__php = new clap_gaji3__php();

// Page init
$lap_gaji3__php->Page_Init();

// Page main
$lap_gaji3__php->Page_Main();
...
?>
<form id="myform" name="myform" class="form-horizontal" method="post" action="lap_gajibrngan.php">
