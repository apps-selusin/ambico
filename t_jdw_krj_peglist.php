...
class ct_jdw_krj_peg_list extends ct_jdw_krj_peg {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// tgl2
			$this->tgl2->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl2->CurrentValue, 0), NULL, $this->tgl2->ReadOnly);
...
<?php } else { ?>
<span id="el<?php echo $t_jdw_krj_peg_list->RowCnt ?>_t_jdw_krj_peg_pegawai_id" class="form-group t_jdw_krj_peg_pegawai_id">
<input type="text" data-table="t_jdw_krj_peg" data-field="x_pegawai_id" name="x<?php echo $t_jdw_krj_peg_list->RowIndex ?>_pegawai_id" id="x<?php echo $t_jdw_krj_peg_list->RowIndex ?>_pegawai_id" size="30" placeholder="<?php echo ew_HtmlEncode($t_jdw_krj_peg->pegawai_id->getPlaceHolder()) ?>" value="<?php echo $t_jdw_krj_peg->pegawai_id->EditValue ?>"<?php echo $t_jdw_krj_peg->pegawai_id->EditAttributes() ?>>
</span>
<?php } ?>
