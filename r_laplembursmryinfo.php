...
//
// Table class for r_laplembur
//
class crr_laplembur extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'r_laplembur';
		$this->TableName = 'r_laplembur';
		...
		// laplembur_id
		$this->laplembur_id = new crField('r_laplembur', 'r_laplembur', 'x_laplembur_id', 'laplembur_id', '`laplembur_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// no
		$this->no = new crField('r_laplembur', 'r_laplembur', 'x_no', 'no', '`no`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// bagian
		$this->bagian = new crField('r_laplembur', 'r_laplembur', 'x_bagian', 'bagian', '`bagian`', 200, EWR_DATATYPE_STRING, -1);
		...
		// divisi
		$this->divisi = new crField('r_laplembur', 'r_laplembur', 'x_divisi', 'divisi', '`divisi`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nama
		$this->nama = new crField('r_laplembur', 'r_laplembur', 'x_nama', 'nama', '`nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nip
		$this->nip = new crField('r_laplembur', 'r_laplembur', 'x_nip', 'nip', '`nip`', 200, EWR_DATATYPE_STRING, -1);
		...
		// jml_jam
		$this->jml_jam = new crField('r_laplembur', 'r_laplembur', 'x_jml_jam', 'jml_jam', '`jml_jam`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// tarif
		$this->tarif = new crField('r_laplembur', 'r_laplembur', 'x_tarif', 'tarif', '`tarif`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// total_lembur
		$this->total_lembur = new crField('r_laplembur', 'r_laplembur', 'x_total_lembur', 'total_lembur', '`total_lembur`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// lapgroup_index
		$this->lapgroup_index = new crField('r_laplembur', 'r_laplembur', 'x_lapgroup_index', 'lapgroup_index', '`lapgroup_index`', 16, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_laplembur`";
	}
