...
$t_keg_detail_grid = NULL; // Initialize page object first

class ct_keg_detail_grid extends ct_keg_detail {
	...
	// Page object name
	var $PageObjName = 't_keg_detail_grid';

	// Grid form hidden field names
	var $FormName = 'ft_keg_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_keg_detail"];
