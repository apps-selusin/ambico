...
//		$item->Visible = TRUE;
	...
	function Page_DataRendered(&$footer) {
		...
		echo "<p><a href='slip_bln.php'><button>Cetak Slip Gaji</button></a></p>";
	}
...
<?php if ($Page->lapgroup_index->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="lapgroup_index"><div class="r_lapgjbln_lapgroup_index"><span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="lapgroup_index">
<?php if ($Page->SortUrl($Page->lapgroup_index) == "") { ?>
		<div class="ewTableHeaderBtn r_lapgjbln_lapgroup_index">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_lapgjbln_lapgroup_index" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->lapgroup_index) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ewSummaryCaption r_lapgjbln_lapgroup_index"><span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->SortUrl($Page->lapgroup_index) == "") { ?>
		<span class="ewSummaryCaption r_lapgjbln_lapgroup_index">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r_lapgjbln_lapgroup_index" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->lapgroup_index) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->lapgroup_index->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->lapgroup_index->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->lapgroup_index->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r_lapgjbln_lapgroup_index"<?php echo $Page->lapgroup_index->ViewAttributes() ?>><?php echo $Page->lapgroup_index->GroupViewValue ?></span>
...
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_lapgjbln_bagian"<?php echo $Page->bagian->ViewAttributes() ?>><?php echo $Page->bagian->GroupViewValue ?></span>
...
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_divisi"<?php echo $Page->divisi->ViewAttributes() ?>><?php echo $Page->divisi->GroupViewValue ?></span>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r_lapgjbln_lapgroup_index"<?php echo $Page->lapgroup_index->ViewAttributes() ?>><?php echo $Page->lapgroup_index->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->bagian->Visible) { ?>
	<?php if ($Page->bagian->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_lapgjbln_bagian"<?php echo $Page->bagian->ViewAttributes() ?>><?php echo $Page->bagian->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->divisi->Visible) { ?>
	<?php if ($Page->divisi->ShowGroupHeaderAsRow) { ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_divisi"<?php echo $Page->divisi->ViewAttributes() ?>><?php echo $Page->divisi->GroupViewValue ?></span></td>
	<?php } ?>
<?php } ?>
<?php if ($Page->rec_no->Visible) { ?>
		<td data-field="rec_no"<?php echo $Page->rec_no->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_rec_no"<?php echo $Page->rec_no->ViewAttributes() ?>><?php echo $Page->rec_no->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->nama->Visible) { ?>
		<td data-field="nama"<?php echo $Page->nama->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_nama"<?php echo $Page->nama->ViewAttributes() ?>><?php echo $Page->nama->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->nip->Visible) { ?>
		<td data-field="nip"<?php echo $Page->nip->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_nip"<?php echo $Page->nip->ViewAttributes() ?>><?php echo $Page->nip->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->gp->Visible) { ?>
		<td data-field="gp"<?php echo $Page->gp->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_gp"<?php echo $Page->gp->ViewAttributes() ?>><?php echo $Page->gp->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->t_jbtn->Visible) { ?>
		<td data-field="t_jbtn"<?php echo $Page->t_jbtn->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_t_jbtn"<?php echo $Page->t_jbtn->ViewAttributes() ?>><?php echo $Page->t_jbtn->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->p_absen->Visible) { ?>
		<td data-field="p_absen"<?php echo $Page->p_absen->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_p_absen"<?php echo $Page->p_absen->ViewAttributes() ?>><?php echo $Page->p_absen->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->t_malam->Visible) { ?>
		<td data-field="t_malam"<?php echo $Page->t_malam->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_t_malam"<?php echo $Page->t_malam->ViewAttributes() ?>><?php echo $Page->t_malam->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->t_hadir->Visible) { ?>
		<td data-field="t_hadir"<?php echo $Page->t_hadir->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_t_hadir"<?php echo $Page->t_hadir->ViewAttributes() ?>><?php echo $Page->t_hadir->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->t_um->Visible) { ?>
		<td data-field="t_um"<?php echo $Page->t_um->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_t_um"<?php echo $Page->t_um->ViewAttributes() ?>><?php echo $Page->t_um->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->j_bruto->Visible) { ?>
		<td data-field="j_bruto"<?php echo $Page->j_bruto->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_j_bruto"<?php echo $Page->j_bruto->ViewAttributes() ?>><?php echo $Page->j_bruto->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->p_aspen->Visible) { ?>
		<td data-field="p_aspen"<?php echo $Page->p_aspen->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_p_aspen"<?php echo $Page->p_aspen->ViewAttributes() ?>><?php echo $Page->p_aspen->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->p_bpjs->Visible) { ?>
		<td data-field="p_bpjs"<?php echo $Page->p_bpjs->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_p_bpjs"<?php echo $Page->p_bpjs->ViewAttributes() ?>><?php echo $Page->p_bpjs->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->j_netto->Visible) { ?>
		<td data-field="j_netto"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_<?php echo $Page->RecCount ?>_r_lapgjbln_j_netto"<?php echo $Page->j_netto->ViewAttributes() ?>><?php echo $Page->j_netto->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php
			...
			$Page->gp->Count = $Page->Cnt[3][4];
			$Page->gp->SumValue = $Page->Smry[3][4]; // Load SUM
			$Page->t_jbtn->Count = $Page->Cnt[3][5];
			$Page->t_jbtn->SumValue = $Page->Smry[3][5]; // Load SUM
			$Page->p_absen->Count = $Page->Cnt[3][6];
			$Page->p_absen->SumValue = $Page->Smry[3][6]; // Load SUM
			$Page->t_malam->Count = $Page->Cnt[3][7];
			$Page->t_malam->SumValue = $Page->Smry[3][7]; // Load SUM
			$Page->t_hadir->Count = $Page->Cnt[3][8];
			$Page->t_hadir->SumValue = $Page->Smry[3][8]; // Load SUM
			$Page->t_um->Count = $Page->Cnt[3][9];
			$Page->t_um->SumValue = $Page->Smry[3][9]; // Load SUM
			$Page->j_bruto->Count = $Page->Cnt[3][10];
			$Page->j_bruto->SumValue = $Page->Smry[3][10]; // Load SUM
			$Page->p_aspen->Count = $Page->Cnt[3][11];
			$Page->p_aspen->SumValue = $Page->Smry[3][11]; // Load SUM
			$Page->p_bpjs->Count = $Page->Cnt[3][12];
			$Page->p_bpjs->SumValue = $Page->Smry[3][12]; // Load SUM
			$Page->j_netto->Count = $Page->Cnt[3][13];
			$Page->j_netto->SumValue = $Page->Smry[3][13]; // Load SUM
			$Page->ResetAttrs();
			$Page->RowType = EWR_ROWTYPE_TOTAL;
			$Page->RowTotalType = EWR_ROWTOTAL_GROUP;
...
<?php } ?>
<?php if ($Page->gp->Visible) { ?>
		<td data-field="gp"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_gp"<?php echo $Page->gp->ViewAttributes() ?>><?php echo $Page->gp->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->t_jbtn->Visible) { ?>
		<td data-field="t_jbtn"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_jbtn"<?php echo $Page->t_jbtn->ViewAttributes() ?>><?php echo $Page->t_jbtn->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->p_absen->Visible) { ?>
		<td data-field="p_absen"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_p_absen"<?php echo $Page->p_absen->ViewAttributes() ?>><?php echo $Page->p_absen->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->t_malam->Visible) { ?>
		<td data-field="t_malam"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_malam"<?php echo $Page->t_malam->ViewAttributes() ?>><?php echo $Page->t_malam->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->t_hadir->Visible) { ?>
		<td data-field="t_hadir"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_hadir"<?php echo $Page->t_hadir->ViewAttributes() ?>><?php echo $Page->t_hadir->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->t_um->Visible) { ?>
		<td data-field="t_um"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_um"<?php echo $Page->t_um->ViewAttributes() ?>><?php echo $Page->t_um->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->j_bruto->Visible) { ?>
		<td data-field="j_bruto"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_j_bruto"<?php echo $Page->j_bruto->ViewAttributes() ?>><?php echo $Page->j_bruto->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->p_aspen->Visible) { ?>
		<td data-field="p_aspen"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_p_aspen"<?php echo $Page->p_aspen->ViewAttributes() ?>><?php echo $Page->p_aspen->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->p_bpjs->Visible) { ?>
		<td data-field="p_bpjs"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_p_bpjs"<?php echo $Page->p_bpjs->ViewAttributes() ?>><?php echo $Page->p_bpjs->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->j_netto->Visible) { ?>
		<td data-field="j_netto"<?php echo $Page->divisi->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_j_netto"<?php echo $Page->j_netto->ViewAttributes() ?>><?php echo $Page->j_netto->SumViewValue ?></span></span></td>
<?php } ?>
	</tr>
<?php } else { ?>
	<tr<?php echo $Page->RowAttributes(); ?>>
...
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_gp"<?php echo $Page->gp->ViewAttributes() ?>><?php echo $Page->gp->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->t_jbtn->Visible) { ?>
		<td data-field="t_jbtn"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_jbtn"<?php echo $Page->t_jbtn->ViewAttributes() ?>><?php echo $Page->t_jbtn->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->p_absen->Visible) { ?>
		<td data-field="p_absen"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_p_absen"<?php echo $Page->p_absen->ViewAttributes() ?>><?php echo $Page->p_absen->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->t_malam->Visible) { ?>
		<td data-field="t_malam"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_malam"<?php echo $Page->t_malam->ViewAttributes() ?>><?php echo $Page->t_malam->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->t_hadir->Visible) { ?>
		<td data-field="t_hadir"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_hadir"<?php echo $Page->t_hadir->ViewAttributes() ?>><?php echo $Page->t_hadir->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->t_um->Visible) { ?>
		<td data-field="t_um"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_t_um"<?php echo $Page->t_um->ViewAttributes() ?>><?php echo $Page->t_um->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->j_bruto->Visible) { ?>
		<td data-field="j_bruto"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_j_bruto"<?php echo $Page->j_bruto->ViewAttributes() ?>><?php echo $Page->j_bruto->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->p_aspen->Visible) { ?>
		<td data-field="p_aspen"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_p_aspen"<?php echo $Page->p_aspen->ViewAttributes() ?>><?php echo $Page->p_aspen->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->p_bpjs->Visible) { ?>
		<td data-field="p_bpjs"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_p_bpjs"<?php echo $Page->p_bpjs->ViewAttributes() ?>><?php echo $Page->p_bpjs->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->j_netto->Visible) { ?>
		<td data-field="j_netto"<?php echo $Page->j_netto->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_<?php echo $Page->GrpCounter[1] ?>_r_lapgjbln_j_netto"<?php echo $Page->j_netto->ViewAttributes() ?>><?php echo $Page->j_netto->SumViewValue ?></span></td>
<?php } ?>
	</tr>
<?php } ?>
<?php
...
<?php if ($Page->SubGrpColumnCount + $Page->DtlColumnCount > 0) { ?>
		<td colspan="<?php echo ($Page->SubGrpColumnCount + $Page->DtlColumnCount) ?>"<?php echo $Page->j_netto->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->bagian->GroupViewValue, $Page->bagian->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[2][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
	</tr>
	<tr<?php echo $Page->RowAttributes(); ?>>
<?php if ($Page->lapgroup_index->Visible) { ?>
