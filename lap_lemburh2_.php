...
$lap_lemburh2__php = NULL; // Initialize page object first

class clap_lemburh2__php {
	...
	// Table name
	var $TableName = 'lap_lemburh2_.php';

	// Page object name
	var $PageObjName = 'lap_lemburh2__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'lap_lemburh2_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "lap_lemburh2__php", $url, "", "lap_lemburh2__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($lap_lemburh2__php)) $lap_lemburh2__php = new clap_lemburh2__php();

// Page init
$lap_lemburh2__php->Page_Init();

// Page main
$lap_lemburh2__php->Page_Main();
...
?>
<form id="myform" name="myform" class="form-horizontal" method="post" action="lap_lemburh2.php">
...
<?php
$lap_lemburh2__php->Page_Terminate();
?>
