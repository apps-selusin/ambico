...
$slip_bln__php = NULL; // Initialize page object first

class cslip_bln__php {
	...
	// Table name
	var $TableName = 'slip_bln_.php';

	// Page object name
	var $PageObjName = 'slip_bln__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'slip_bln_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "slip_bln__php", $url, "", "slip_bln__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($slip_bln__php)) $slip_bln__php = new cslip_bln__php();

// Page init
$slip_bln__php->Page_Init();

// Page main
$slip_bln__php->Page_Main();
...
?>
<form id="myform" name="myform" class="form-horizontal" method="post" action="slip_bln.php">
