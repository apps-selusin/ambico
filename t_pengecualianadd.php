...
$t_pengecualian_add = NULL; // Initialize page object first

class ct_pengecualian_add extends ct_pengecualian {
	...
	// Page object name
	var $PageObjName = 't_pengecualian_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_pengecualianlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_pengecualianview.php")
...
// Create page object
if (!isset($t_pengecualian_add)) $t_pengecualian_add = new ct_pengecualian_add();

// Page init
$t_pengecualian_add->Page_Init();

// Page main
$t_pengecualian_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_pengecualian_add->Page_Render();
?>
...
var CurrentForm = ft_pengecualianadd = new ew_Form("ft_pengecualianadd", "add");

// Validate form
ft_pengecualianadd.Validate = function() {
...
ft_pengecualianadd.Form_CustomValidate = 
...
ft_pengecualianadd.ValidateRequired = true;
<?php } else { ?>
ft_pengecualianadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_pengecualianadd.Lists["x_pegawai_id"] = {"LinkField":"x_pegawai_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pegawai_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pegawai"};
ft_pengecualianadd.Lists["x_tipe"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_pengecualianadd.Lists["x_tipe"].Options = <?php echo json_encode($t_pengecualian->tipe->Options()) ?>;
...
<?php if (!$t_pengecualian_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_pengecualian_add->ShowPageHeader(); ?>
<?php
$t_pengecualian_add->ShowMessage();
?>
<form name="ft_pengecualianadd" id="ft_pengecualianadd" class="<?php echo $t_pengecualian_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_pengecualian_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_pengecualian_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft_pengecualianadd", "x_tgl", 0);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_pengecualian_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_pengecualianadd.Init();
</script>
<?php
$t_pengecualian_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_pengecualian_add->Page_Terminate();
?>
