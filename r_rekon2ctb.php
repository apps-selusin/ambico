...
<input type="text" data-table="r_rekon2" data-field="x_pembagian2_nama" id="sv_pembagian2_nama" name="sv_pembagian2_nama" size="30" maxlength="100" placeholder="<?php echo $Page->pembagian2_nama->PlaceHolder ?>" value="<?php echo ewr_HtmlEncode($Page->pembagian2_nama->SearchValue) ?>"<?php echo $Page->pembagian2_nama->EditAttributes() ?>>
</span>
</div>
</div>
...
<?php if ($Page->Export == "" && !$Page->DrillDown) { ?>
				<a class="ewTableHeaderPopup" title="<?php echo $ReportLanguage->Phrase("Filter"); ?>" onclick="ewr_ShowPopup.call(this, event, 'r_rekon2_tgl', true, '<?php echo $Page->tgl->RangeFrom ?>', '<?php echo $Page->tgl->RangeTo ?>');" name="x_tgl" id="x_tgl"><span class="icon-filter"></span></a>
<?php } ?>
			</div>
		</td>
	</tr>
