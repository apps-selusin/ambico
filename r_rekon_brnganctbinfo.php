...
//
// Table class for r_rekon_brngan
//
class crr_rekon_brngan extends crTableCrosstab {
	var $pegawai_id;
	var $tgl;
	var $scan_masuk;
	var $scan_keluar;
	...
	function __construct() {
		...
		$this->TableVar = 'r_rekon_brngan';
		$this->TableName = 'r_rekon_brngan';
		...
		// pegawai_id
		$this->pegawai_id = new crField('r_rekon_brngan', 'r_rekon_brngan', 'x_pegawai_id', 'pegawai_id', '`pegawai_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// tgl
		$this->tgl = new crField('r_rekon_brngan', 'r_rekon_brngan', 'x_tgl', 'tgl', '`tgl`', 133, EWR_DATATYPE_DATE, -1);
		...
		// scan_masuk
		$this->scan_masuk = new crField('r_rekon_brngan', 'r_rekon_brngan', 'x_scan_masuk', 'scan_masuk', '`scan_masuk`', 135, EWR_DATATYPE_DATE, 17);
		...
		// scan_keluar
		$this->scan_keluar = new crField('r_rekon_brngan', 'r_rekon_brngan', 'x_scan_keluar', 'scan_keluar', '`scan_keluar`', 135, EWR_DATATYPE_DATE, 17);
		...
		// pegawai_nip
		$this->pegawai_nip = new crField('r_rekon_brngan', 'r_rekon_brngan', 'x_pegawai_nip', 'pegawai_nip', '`pegawai_nip`', 200, EWR_DATATYPE_STRING, -1);
		...
		// pegawai_nama
		$this->pegawai_nama = new crField('r_rekon_brngan', 'r_rekon_brngan', 'x_pegawai_nama', 'pegawai_nama', '`pegawai_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// pegawai_pin
		$this->pegawai_pin = new crField('r_rekon_brngan', 'r_rekon_brngan', 'x_pegawai_pin', 'pegawai_pin', '`pegawai_pin`', 200, EWR_DATATYPE_STRING, -1);
	...
	function getSqlDistinctSelect() {
		return ($this->_SqlDistinctSelect <> "") ? $this->_SqlDistinctSelect : "SELECT DISTINCT DATE_FORMAT(`tgl`,'%Y-%m-%d') FROM `v_jdw_krj_brngan`";
	}
